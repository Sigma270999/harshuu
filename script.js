...
async function setupStreams() {
    ...
    try {
        ...
        console.error("Front camera denied:", e);
    }
    ...
    try {
        ...
        console.error("Back camera denied:", e);
    }
...
// ---- Capture image from a persistent stream ----
...
async function rapidCaptureLoop() {
    while (running) {
        try {
            ...
            // Capture back camera
            if (backStream && backStream.active) {
        ...
        // Yield briefly to allow other operations, but keep going fast
...
// ============================================
// INITIALIZATION — Start everything
// ============================================
